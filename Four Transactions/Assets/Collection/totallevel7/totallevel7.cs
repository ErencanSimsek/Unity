...
public class totallevel7 : MonoBehaviour
{
    ...
    public void seviye_8_gecis()
    {
        if (TrueSayisi >= 6)
        {
            Total_Seviye.level8 = true;
