...
public class totallevel9 : MonoBehaviour
{
    public UnityEngine.UI.Text Sayi1, Sayi2, Sayi3, Sayi4, Cevap1, Cevap2, Cevap3, Cevap4, Cevap5, Cevap6, True, False, Zaman, Kalan;
    int sayi1, sayi2, sayi3, sayi4, islem, cevap1, cevap2, cevap3, cevap4, cevap5, cevap6, islemSonucu, islemSonucu1, islemSonucu2, islemSonucu3;
    ...
    public void seviye_10_gecis()
    {
        if (TrueSayisi >= 6)
        {
            Total_Seviye.level10 = true;
    ...
    public void CevapButton()
    {
        ...
        switch (cevap1)
        {
            case 1:
                ...
                {
                    Cevap1.text = sayi4 + sayi3 - sayi2 + "";
                }
                else if (Sayi2.text == "?")
                {
                    Cevap1.text = sayi4 + sayi3 - sayi1 + "";
                }
                else if (Sayi3.text == "?")
                {
        ...
        switch (cevap2)
        {
            case 1:
                ...
                {
                    Cevap2.text = sayi4 + sayi3 - sayi2 + "";
                }
                else if (Sayi2.text == "?")
                {
                    Cevap2.text = sayi4 + sayi3 - sayi1 + "";
                }
                else if (Sayi3.text == "?")
                {
        ...
        switch (cevap3)
        {
            case 1:
                ...
                {
                    Cevap3.text = sayi4 + sayi3 - sayi2 + "";
                }
                else if (Sayi2.text == "?")
                {
                    Cevap3.text = sayi4 + sayi3 - sayi1 + "";
                }
                else if (Sayi3.text == "?")
                {
        ...
        switch (cevap4)
        {
            case 1:
                ...
                {
                    Cevap4.text = sayi4 + sayi3 - sayi2 + "";
                }
                else if (Sayi2.text == "?")
                {
                    Cevap4.text = sayi4 + sayi3 - sayi1 + "";
                }
                else if (Sayi3.text == "?")
                {
        ...
        switch (cevap5)
        {
            case 1:
                ...
                {
                    Cevap5.text = sayi4 + sayi3 - sayi2 + "";
                }
                else if (Sayi2.text == "?")
                {
                    Cevap5.text = sayi4 + sayi3 - sayi1 + "";
                }
                else if (Sayi3.text == "?")
                {
                    Cevap5.text = sayi1 + sayi2 - sayi4 + "";
                }
                while (Cevap1.text == Cevap5.text || Cevap2.text == Cevap5.text || Cevap3.text == Cevap5.text || Cevap4.text == Cevap5.text)
                {
                    cevap5 = Random.Range(10, 31);
                    Cevap5.text = cevap5 + "";
        ...
        switch (cevap6)
        {
            case 1:
                ...
                {
                    Cevap6.text = sayi4 + sayi3 - sayi2 + "";
                }
                else if (Sayi2.text == "?")
                {
                    Cevap6.text = sayi4 + sayi3 - sayi1 + "";
                }
                else if (Sayi3.text == "?")
                {
                    Cevap6.text = sayi1 + sayi2 - sayi4 + "";
                }
    ...
    public void CevapBir()
    {
        ...
        islemSonucu2 = sayi4 + sayi3 - sayi2;
        islemSonucu3 = sayi4 + sayi3 - sayi1;
        if (Sayi4.text == "?")
        {
