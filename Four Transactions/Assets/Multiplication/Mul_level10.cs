...
public class Mul_level10 : MonoBehaviour
{
    public UnityEngine.UI.Text Sayi1, Sayi2, Sayi3, Sayi4, Sayi5, Sayi6, True, False, Zaman, Kalan, ebk, Cevap1, Cevap2, Cevap3;
    int sayi1, sayi2, sayi3, sayi4, sayi5, sayi6, islem, islemSonucu, islemSonucu1, islemSonucu2, islemSonucu3;
    ...
    public void YeniSoru()
    {
        ...
        sayi3 = Random.Range(1, 9);
        sayi4 = Random.Range(1, 9);
        sayi5 = Random.Range(1, 9);
        sayi6 = Random.Range(1, 9);
        ebk.text = "?";
        Cevap1.text = "=";
        Cevap2.text = ">";
        Cevap3.text = "<";
    ...
    public void esit()
    {
        if (sayi5 * sayi4 * sayi6 == sayi1 * sayi2 * sayi3)
        {
