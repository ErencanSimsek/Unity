...
public class Mul_level3 : MonoBehaviour
{
    ...
    public void seviye_4_gecis()
    {
        if (TrueSayisi >= 6)
        {
            Multiplication_gecis.level4 = true;
