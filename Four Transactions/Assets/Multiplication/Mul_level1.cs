...
public class Mul_level1 : MonoBehaviour
{
    ...
    public void seviye_2_gecis()
    {
        if (TrueSayisi >= 6)
        {
            Multiplication_gecis.level2 = true;
